...
<head>
    ...
    <title>Game Request NIGHTCRACK</title>
<style>
...
<article id="posts">
        <form action="action_page.php">
            ...
            <br>    
            <input type="text" name="Game_name" value="" placeholder="Game Request">
            <br>
            
    
        <input type="submit" value="Submit" class="submit"><a href="form.html"></a>  
</div>
          </form> 
</article>
<div class="bg">
